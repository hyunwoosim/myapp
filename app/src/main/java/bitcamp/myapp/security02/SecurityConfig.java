...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        // 2) 어떤 HTTP요청에 대해 시큐리티 필터를 적용할지 설정한다.
        ...
        http
            ...
            .formLogin(new Customizer<FormLoginConfigurer<HttpSecurity>>() {
                ...
                public void customize(FormLoginConfigurer<HttpSecurity> FormLoginConfigurer) {
                    ...
                    FormLoginConfigurer.usernameParameter("email"); // 로그인 수행할때 사용할 사용자 아이디 또는 이메일(principal) 파라미터 명
                    FormLoginConfigurer.passwordParameter("password"); // 로그인 수행할때 사용할 사용자 암호(credential) 파라미터 명
                    FormLoginConfigurer.defaultSuccessUrl("/home",true); // 로그인 성공후 리다이렉트 할 URL
